...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет урон, наносимый противнику, в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет количество заблокированного урона в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Запускает тренировку и позволяет использовать базовые команды."""
    if char_class == 'warrior':
